            ...
            <Tile
                ...
                content={
                    <>
                        ...
                        <Typography type='body' fontFamily='sans-serif' content='Typography body' textAlign='justify' inline link='http://lewisbritton.com' />{' '}
                        <Typography type='body' fontFamily='sans-serif' content='Typography body bold-faced ' textAlign='justify' boldFace inline link='http://lewisbritton.com' />{' '}
                        <Typography type='body' fontFamily='sans-serif' content='Typography body italicized' textAlign='justify' italicize inline link='http://lewisbritton.com' />{' '}
                        <Typography type='body' fontFamily='sans-serif' content='Typography body bold-faced and italicized' textAlign='justify' boldFace italicize inline link='http://lewisbritton.com' />
