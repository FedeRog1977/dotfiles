    ...
    return (
        <>
            ...
            <Tile
                ...
                content={
                    <>
                        <Typography type='t1' fontFamily='serif' content='Typography t1' textAlign='left' paragraphMargins />
                        <Typography type='t2' fontFamily='serif' content='Typography t2' textAlign='left' paragraphMargins />
                        <Typography type='h1' fontFamily='serif' content='Typography h1' textAlign='left' paragraphMargins />
                        <Typography type='h2' fontFamily='serif' content='Typography h2' textAlign='left' paragraphMargins />
                        <Typography type='h3' fontFamily='serif' content='Typography h3' textAlign='left' paragraphMargins />
                        <Typography type='body' fontFamily='serif' content='Typography body' textAlign='justify' inline paragraphMargins />{' '}
                        <Typography type='body' fontFamily='serif' content='Typography body bold-faced ' textAlign='justify' boldFace inline paragraphMargins />{' '}
                        <Typography type='body' fontFamily='serif' content='Typography body italicized' textAlign='justify' italicize inline paragraphMargins />{' '}
