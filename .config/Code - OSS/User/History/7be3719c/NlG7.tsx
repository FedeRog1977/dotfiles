    ...
    return (
        <>
            <Tile
                ...
                content={
                    <>
                        <Typography type='t1' fontFamily='sans-serif' content='Typography' textAlign='center' />
                        <Typography type='t2' fontFamily='sans-serif' content='Serif Types' textAlign='center' />
                    </>
                }
            />
            <Tile
