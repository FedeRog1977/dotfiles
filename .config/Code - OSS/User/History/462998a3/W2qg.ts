...
export type ArticleTileBookShelfProps = { body: BookshelfProps[] }
export type ArticleTileImageMatrixProps = { body: ImageMatrixProps['items'] }
...
export type ArticleTileProps = {
    ...
    margins?: boolean
    sections: {
        TheElement: React.ComponentType<any>
        content:
