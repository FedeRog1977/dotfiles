                ...
                items: [
                    {
                        ...
                        alt: 'T420',
                        description:
                            '[Lenovo ThinkPad T420](https://download.lenovo.com/ibmdl/pub/pc/pccbbs/thinkcentre_pdf/0b03687.pdf)<sup>[1](:target="_blank"https://lewisbritton.com/){:target="_blank"}</sup>',
                    },
                    {
