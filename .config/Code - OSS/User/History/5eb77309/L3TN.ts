...
const compileProjects = () => {
    ...
    const islandsUnq = removeDuplicates(islands);
    const munrosUnq = removeDuplicates(munros);
    const munroTopsUnq = removeDuplicates(munroTops);
    const corbettsUnq = removeDuplicates(corbetts);
    const CorbettTopsUnq = removeDuplicates(corbettTops);
    const grahamsUnq = removeDuplicates(grahams);
    const subTwosUnq = removeDuplicates(subTwos);
    const donaldsUnq = removeDuplicates(donalds);

    // Numbers of'

    const islandsN = islandsUnq.length;
    const islandsUnqN = islandsUnq.length;
    const islands2023N = islands2023.length;
    const islands2022N = islands2022.length;
    const islands2021N = islands2021.length;
    const islands2020N = islands2020.length;
