...
const compileProjects = () => {
    ...
    for (var i in sportData[2022].projects) {
        ...
        totalProjectElev2023 = totalProjectElev2023 + sportData[2022].roadies[i].elev;
    }
    ...
    for (var i in sportData[2021].projects) {
        ...
        totalProjectElev2023 = totalProjectElev2023 + sportData[2021].roadies[i].elev;
    }
    ...
    for (var i in sportData[2020].projects) {
        ...
        totalProjectElev2023 = totalProjectElev2023 + sportData[2020].roadies[i].elev;
    }
