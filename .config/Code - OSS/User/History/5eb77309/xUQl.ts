...
const compileProjects = () => {
    ...
    const allProjects2023 = sportData[2023].projects;
    const allProjects2022 = sportData[2022].projects;
    const allProjects2021 = sportData[2021].projects;
    const allProjects2020 = sportData[2020].projects;
