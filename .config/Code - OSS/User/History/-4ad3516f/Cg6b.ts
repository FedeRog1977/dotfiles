...
export const miamiViceContent: MiamiViceProps = {
    ...
    tileOne: {
        season1: [
            ...
            {
                heading: 'Calderone’s Return – Part I: The Hit List',
                subHeading: 'I’m So Excited – The Pointer Sisters',
                video: 'V-6WfNORElM',
            },
            {
                heading: 'Calderone’s Return – Part I: The Hit List',
                subHeading: 'In the Night – Russ Ballard',
                video: 'ARiSJWjmFW4',
            },
            {
                heading: 'Calderone’s Return – Part II: Calderone’s Demise',
                subHeading: 'Voices – Russ Ballard',
                video: 'YaWVUhudI9I',
            },
            {
                heading: 'Calderone’s Return – Part II: Calderone’s Demise',
                subHeading: 'What’s Love Got To Do With It – Tina Turner',
                video: 'kee8MS-QK5E',
            },
            {
                heading: 'No Exit',
