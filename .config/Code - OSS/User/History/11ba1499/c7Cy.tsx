...
function BashBlocks() {
    return (
        <div>
            ...
            <Typography type='body' fontFamily='serif' content='Typography body' textAlign='justify' inline mT='20px' mB='30px' />{' '}
            <Typography type='body' fontFamily='serif' content='Typography body bold-faced ' textAlign='justify' boldFace inline mT='20px' mB='30px' />{' '}
            <Typography type='body' fontFamily='serif' content='Typography body italicized' textAlign='justify' italicize inline /mT='20px' mB='30px' >{' '}
            ...
            <Typography type='body' fontFamily='sans-serif' content='Typography body' textAlign='justify' inline mT='20px' mB='30px' />{' '}
            <Typography type='body' fontFamily='sans-serif' content='Typography body bold-faced ' textAlign='justify' boldFace inline mT='20px' mB='30px' />{' '}
            <Typography type='body' fontFamily='sans-serif' content='Typography body italicized' textAlign='justify' italicize inline mT='20px' mB='30px' />{' '}
