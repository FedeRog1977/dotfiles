...
function BashBlocks() {
    return (
        <div>
            ...
            <hr />
            <Typography type='h1' fontFamily='sans-serif' content='Typography overline' textAlign='left' inline textDecoration='overline' />{' '}
            <Typography type='h1' fontFamily='sans-serif' content='Typography strike-through' textAlign='left' inline textDecoration='line-through' />{' '}
            <Typography type='h1' fontFamily='sans-serif' content='Typography underline' textAlign='left' inline textDecoration='underline' />
        </div>
    );
}
