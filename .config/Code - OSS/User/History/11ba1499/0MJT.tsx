...
function BashBlocks() {
    return (
        <div>
            ...
            <hr />
            <Typography type='h1' fontFamily='sans-serif' content='Typography overline' textAlign='left' inline />{' '}
            <Typography type='h1' fontFamily='sans-serif' content='Typography strike-through' textAlign='left' inline />{' '}
            <Typography type='h1' fontFamily='sans-serif' content='Typography underline' textAlign='left' inline />
        </div>
    );
}
