    ...
    return (
        <>
            ...
            <Tile
                type='clear-condensed'
                content={
                    <Typography type='t2' fontFamily='sans-serif' content='With Description' textAlign='center' paragraphMargins />
                }
            />
            <Tile
                type='solid'
            ...
            <Tile
                type='clear-condensed'
                content={
                    <Typography type='t2' fontFamily='sans-serif' content='Without Description' textAlign='center' paragraphMargins />
                }
            />
            <Tile
                type='solid'
