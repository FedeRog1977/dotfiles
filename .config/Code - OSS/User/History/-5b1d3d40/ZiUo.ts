...
const compileRoadies = () => {
    ...
    for (var i in sportData[2023].roadies) {
        var totalRoadieMiles2023: any = totalRoadieMiles2023 + sportData[2023].roadies[i].dist;
        var totalRoadieElev2023: any = totalRoadieElev2023 + sportData[2023].roadies[i].elev;
    }

    for (var i in sportData[2022].roadies) {
        var totalRoadieMiles2022: any = totalRoadieMiles2022 + sportData[2022].roadies[i].dist;
        var totalRoadieElev2022: any = totalRoadieElev2022 + sportData[2022].roadies[i].elev;
    }

    for (var i in sportData[2021].roadies) {
        var totalRoadieMiles2021: any = totalRoadieMiles2021 + sportData[2021].roadies[i].dist;
        var totalRoadieElev2021: any = totalRoadieElev2021 + sportData[2021].roadies[i].elev;
    }

    for (var i in sportData[2020].roadies) {
        var totalRoadieMiles2020: any = totalRoadieMiles2020 + sportData[2020].roadies[i].dist;
        var totalRoadieElev2020: any = totalRoadieElev2020 + sportData[2020].roadies[i].elev;
    }
    ...
    const roadiesElevation: any[] = [];
    roadiesElevation.push({
        'total': (
            toFeet(
                totalRoadieElev2023
                + totalRoadieElev2022
