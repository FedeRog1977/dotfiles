...
const compileRoadies = () => {
    ...
    const allRoadies2023 = sportData[2023].roadies;
    const allRoadies2022 = sportData[2022].roadies;
    const allRoadies2021 = sportData[2021].roadies;
    const allRoadies2020 = sportData[2020].roadies;
    ...
    for (var i in sportData[2023].roadies) {
        allRoadies.push({ '2023': sportData[2023].roadies[i] });
