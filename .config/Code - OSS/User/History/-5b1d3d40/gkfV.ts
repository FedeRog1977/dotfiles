...
const compileRoadies = () => {
    ...
    for (var i in sportData[2022].roadies) {
        ...
        totalRoadieElev2023 = totalRoadieElev2023 + sportData[2022].roadies[i].elev;
    }
    ...
    for (var i in sportData[2021].roadies) {
        ...
        totalRoadieElev2023 = totalRoadieElev2023 + sportData[2021].roadies[i].elev;
    }
    ...
    for (var i in sportData[2020].roadies) {
        ...
        totalRoadieElev2023 = totalRoadieElev2023 + sportData[2020].roadies[i].elev;
    }
