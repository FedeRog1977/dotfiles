...
const InstantGramTile: FC<InstantGramTileProps> = (
    ...
    eventFull.push({ "namePrefix": event.namePrefix }, sportDist, sportElev, sportTime, sportIslands, sportMunros, sportMunroTops, sportCorbetts, sportCorbettTops, sportGrahams, sportSubTwos, sportDonalds);
