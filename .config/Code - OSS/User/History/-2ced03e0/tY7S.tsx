...
const InstantGramTile: FC<InstantGramTileProps> = (
    ...
    eventFull.push(event, sportDist, sportElev, sportTime, sportIslands, sportMunros, sportMunroTops, sportCorbetts, sportCorbettTops, sportGrahams, sportSubTwos, sportDonalds);
