...
const InstantGramTile: FC<InstantGramTileProps> = (
    ...
    var corbetts = `${sportEvent.corbetts.join(', ')}`;
    var corbettTops = `${sportEvent.corbettTops.join(', ')}`;
    var grahams = `${sportEvent.grahams.join(', ')}`;
    var subTwos = `${sportEvent.subTwos.join(', ')}`;
    var donalds = `${sportEvent.donalds.join(', ')}`;
