...
const refactorEvent = (
    ...
    refactoredEvent.push({
        ...
        images: eventImages,
        eventYouthHostels,
        sport_distance: sportDist,
        sport_elevation: sportElev,
        sport_time: sportTime,
        sport_islands: sportIslands,
        sport_munros: sportMunros,
        sport_munro_tops: sportMunroTops,
        sport_corbetts: sportCorbetts,
        sport_corbett_tops: sportCorbettTops,
        sport_grahams: sportGrahams,
        sport_sub_twos: sportSubTwos,
        sport_donalds: sportDonalds,
        show_sport: showSportEvent,
    });
