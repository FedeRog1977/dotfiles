...
const refactorEvent = ({ event, sportEvent, showSportEvent }: any) => {
    ...
    refactoredEvent = {
        ...
        sportIslands: islandSetAggregate.join(', '),
        sportMunros: munroSetAggregate.join(', '),
        sportMunroTops: munroTopSetAggregate.join(', '),
        sportCorbetts: corbettSetAggregate.join(', '),
        sportCorbettTops: corbettTopSetAggregate.join(', '),
        sportGrahams: grahamSetAggregate.join(', '),
        sportSubTwos: subTwoSetAggregate.join(', '),
        sportDonalds: donaldSetAggregate.join(', '),
        showSportEvent,
    }
