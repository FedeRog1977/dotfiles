...
import { removeDuplicates } from '../formatters/remove-duplicates'
...
const compileProjects = () => {
    ...
    for (var i in sportData[2023].projects) {
        totalProjectMiles2023 =
            totalProjectMiles2023 + sportData[2023].projects[i].dist
        totalProjectElev2023 =
            totalProjectElev2023 + sportData[2023].projects[i].elev
    ...
    for (var i in sportData[2022].projects) {
        totalProjectMiles2022 =
            totalProjectMiles2022 + sportData[2022].projects[i].dist
        totalProjectElev2022 =
            totalProjectElev2022 + sportData[2022].projects[i].elev
    ...
    for (var i in sportData[2021].projects) {
        totalProjectMiles2021 =
            totalProjectMiles2021 + sportData[2021].projects[i].dist
        totalProjectElev2021 =
            totalProjectElev2021 + sportData[2021].projects[i].elev
    ...
    for (var i in sportData[2020].projects) {
        totalProjectMiles2020 =
            totalProjectMiles2020 + sportData[2020].projects[i].dist
        totalProjectElev2020 =
            totalProjectElev2020 + sportData[2020].projects[i].elev
