...
export const compileProjects = () => {
    ...
    const munroData = {
        names: {
            munros: munrosTotal.sort(),
        },
        number: {},
        munrosUnq: removeDuplicates(munrosTotal).sort(),
        munrosN: munrosTotal.length,
        munrosUnqN: removeDuplicates(munrosTotal).length,
    ...
    const munroTopData = {
        names: {},
        number: {},
        munroTops: munroTopsTotal.sort(),
        munroTopsUnq: removeDuplicates(munroTopsTotal).sort(),
        munroTopsN: munroTopsTotal.length,
        munroTopsUnqN: removeDuplicates(munroTopsTotal).length,
    ...
    const corbettData = {
        names: {},
        number: {},
        corbetts: corbettsTotal.sort(),
        corbettsUnq: removeDuplicates(corbettsTotal).sort(),
        corbettsN: corbettsTotal.length,
        corbettsUnqN: removeDuplicates(corbettsTotal).length,
    ...
    const corbettTopData = {
        names: {},
        number: {},
        corbettTops: corbettTopsTotal.sort(),
        corbettTopsUnq: removeDuplicates(corbettTopsTotal).sort(),
        corbettTopsN: corbettTopsTotal.length,
        corbettTopsUnqN: removeDuplicates(corbettTopsTotal).length,
    ...
    const grahamData = {
        names: {},
        number: {},
        grahams: grahamsTotal.sort(),
        grahamsUnq: removeDuplicates(grahamsTotal).sort(),
        grahamsN: grahamsTotal.length,
        grahamsUnqN: removeDuplicates(grahamsTotal).length,
    ...
    const subTwoData = {
        names: {},
        number: {},
        subTwos: subTwosTotal.sort(),
        subTwosUnq: removeDuplicates(subTwosTotal).sort(),
        subTwosN: subTwosTotal.length,
        subTwosUnqN: removeDuplicates(subTwosTotal).length,
    ...
    const donaldData = {
        names: {},
        number: {},
        donalds: donaldsTotal.sort(),
        donaldsUnq: removeDuplicates(donaldsTotal).sort(),
        donaldsN: donaldsTotal.length,
        donaldsUnqN: removeDuplicates(donaldsTotal).length,
