        ...
        <Tile type="solid" dense={isMobile && true}>
            <>
                <div className="instant-gram-tile-title">
                    {refactoredEvent[0].eventPrefix && (
                        <>
                            <Typography
                                type="h1"
                                content={refactoredEvent[0].eventPrefix}
                                inline
                            />
                ...
                <div className="instant-gram-tile-title">
                    <Typography
                        type="h3"
                        content={refactoredEvent[0].eventStartDate}
                        textAlign="left"
                        color="#585858"
                        inline
                    />
                    {refactoredEvent[0].eventEndDate && (
                        <>
                            ...
                            <Typography
                                type="h3"
                                content={refactoredEvent[0].eventEndDate}
                                textAlign="left"
                                color="#585858"
                                inline
                            />
                ...
                {showDropDown && (
                    <div className="instant-gram-tile-body">
                        {Array.isArray(refactoredEvent[0].eventDescription) ? (
                            <Article
                                sections={refactoredEvent[0].eventDescription}
                                textAlign="justify"
                            />
                        ) : (
                            <Typography
                                type="body"
                                content={refactoredEvent[0].eventDescription}
                                textAlign="justify"
                                paragraphMargins
                            />
                        )}
