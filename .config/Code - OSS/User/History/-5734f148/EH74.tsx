...
export const meta: Meta<typeof ImageTile> = {
    component: ImageTile,
}

// export default meta;

type ImageTileStoryProps = StoryObj<typeof ImageTile>

const args: ImageTileProps = {
...
export const ImageTileStory: ImageTileStoryProps = {
    render: () => <ImageTile {...args} />,
}
