                    ...
                    rightColumns={[
                        {
                            title: 'Occurrences',
                            entries: [
                                `${props.sportData.occurences.total}`,
                                `${props.sportData.occurences[2024]}`,
                                `${props.sportData.occurences[2023]}`,
                                `${props.sportData.occurences[2022]}`,
                                `${props.sportData.occurences[2021]}`,
                                `${props.sportData.occurences[2020]}`,
                            ],
                        },
                        {
                            title: 'Distance',
