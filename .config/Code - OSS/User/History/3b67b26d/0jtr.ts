            ...
            route: [
                {
                    ...
                    elevationgain: 6423,
                    stdtime: 9,
                    type: ['hillwalk', 'ridgewalk'],
                    stage: ['walk-in', 'approach', 'on-hill', 'walk-out'],
                    terraintype: ['road', 'path'],
                    terraindiff: [
                        'concrete',
                        'stone staircase',
                        'broken rock',
                ...
                },
                {
                    ...
                    type: ['hillwalk'],
                    stage: ['walk-in', 'approach', 'on-hill', 'walk-out'],
                    terraintype: ['road', 'farm path', 'footpath erosion'],
                    terraindiff: [
                        'concrete',
                        'broken rock',
                        'grass',
                ...
                },
                {
                    ...
                    stdtime: 6,
                    type: ['hillwalk'],
                    stage: ['walk-in', 'on-hill', 'walk-out'],
                    terraintype: ['road', 'path'],
                    terraindiff: [
                        'concrete',
                        'broken rock',
            ...
            route: [
                {
                    ...
                    type: ['hillwalk'],
                    stage: ['walk-in', 'approach', 'on-hill', 'walk-out'],
                    terraintype: ['farm path', 'path', 'footpath erosion'],
                    terraindiff: [
                        'grass',
                        'broken rock',
                        'grass with scattered rock',
            ...
            route: [
                {
                    ...
                    stdtime: 11,
                    type: ['hillwalk'],
                    stage: ['approach', 'on-hill', 'walk-out'],
                    terraintype: ['road', 'path', 'footpath erosion'],
                    terraindiff: [
                        'concrete',
                        'grass',
