            ...
            <Tile
                ...
                content={
                    <>
                        ...
                        />
                        <Typography type='h3' content={<>2023: {compileProjects().projectsElev[0][2023]}</>} paragraphMargins />
                        {compileProjects().projects[2023].map(
                            ({ id, name, dist, elev, time }: any) => (
                                <div key={id}>
                                    <Typography type='h4' content={<>{name}:</>} inline boldFace />{' '}
                                    <Typography type='h4' content={<>{dist}mi</>} inline />{' '}
                        ...
                        <Typography type='h3' content={<>2022: {compileProjects().projectsElev[0][2022]}</>} paragraphMargins />
                        {compileProjects().projects[2022].map(
                            ({ id, name, dist, elev, time }: any) => (
                                <div key={id}>
                                    <Typography type='h4' content={<>{name}:</>} inline boldFace />{' '}
                                    <Typography type='h4' content={<>{dist}mi</>} inline />{' '}
                        ...
                        <Typography type='h3' content={<>2021: {compileProjects().projectsElev[0][2021]}</>} paragraphMargins />
                        {compileProjects().projects[2021].map(
                            ({ id, name, dist, elev, time }: any) => (
                                <div key={id}>
                                    <Typography type='h4' content={<>{name}:</>} inline boldFace />{' '}
                                    <Typography type='h4' content={<>{dist}mi</>} inline />{' '}
                        ...
                        <Typography type='h3' content={<>2020: {compileProjects().projectsElev[0][2020]}</>} paragraphMargins />
                        {compileProjects().projects[2020].map(
                            ({ id, name, dist, elev, time }: any) => (
                                <div key={id}>
                                    <Typography type='h4' content={<>{name}:</>} inline boldFace />{' '}
                                    <Typography type='h4' content={<>{dist}mi</>} inline />{' '}
